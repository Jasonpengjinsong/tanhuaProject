package com.halead.recommend.msg;

import com.fasterxml.jackson.databind.JsonNode;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.halead.dubbo.pojo.Publish;
import com.halead.recommend.pojo.RecommendQuanZi;
...
/**
 * @title: QuanZiMsgConsumer
 * @Author ppjjss
 * @Date: 2022/7/19 22:31
 * @Version 1.0
 */
@Component
@RocketMQMessageListener(topic = "tanhua_quanzi",consumerGroup = "tanhua_quanzi_consumer")
